                ...
                <div class="row">
                    ...
                    <h3 style="text-align: center;">Instruido por John Doe Doe</h2>
                      ...
                      <div class="row">
                        <div class="col-2"></div>
                        <div class="col-10">
                            <img class="img-fluid rounded" style="text-align: center;" src="http://placehold.it/850x500" alt="">
                            <br>
                        </div>
                        <br>
                      </div>
                    ...
                    <div style="text-align: center; padding-top: 3%;" id="paypal-button-container"></div>
